...
pc1.onicecandidate = function (e) {
  console.log('ICE candidate (pc1)', e)
   if(e.candidate){
	//  alert ("add ice candidate to other Pc2");
	   onIceCandidate(pc1, e);
  }
  if (e.candidate == null) {
	//   alert ("pc1 on icecandidate");
    $('#localOffer').html(JSON.stringify(pc1.localDescription))
	 console.log("local Answer pc1 local description  " + JSON.stringify(pc1.localDescription));
  }
}
...
function handleOnaddstream (e) {
 ...
 // el.src = URL.createObjectURL(e.stream)
 el.src = e.stream;
}
...
pc2.onicecandidate = function (e) {
  ...
  if(e.candidate){
	//  alert ("add ice candidate to other Pc1");
	  onIceCandidate(pc2, e);
  }
  if (e.candidate == null) {
	//  alert ("pc2 on icecandidate");
    $('#localAnswer').html(JSON.stringify(pc2.localDescription))
	 console.log("local Answer pc2 local description  " + JSON.stringify(pc2.localDescription));
  }
}
