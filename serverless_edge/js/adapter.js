...
//  alert("browser  = "+browserDetails.browser);
...
var chromeShim = {
  ...
  attachMediaStream: function(element, stream) {
	  alert("In attachMediaStream adapter.js");
	  alert("browser version "+browserDetails.version);
...
var edgeShim = {
    ...
    window.RTCPeerConnection.prototype.setLocalDescription =
        function(description) {
          ...
          if (description.type === 'offer') {
			...
			//  alert(" description.type is answer");
            ...
            sections.forEach(function(mediaSection, sdpMLineIndex) {
              ...
              if (!rejected) {
                ...
                var remoteDtlsParameters = SDPUtils.getDtlsParameters(
                    mediaSection, sessionpart);
					//alert("remoteDtlsParameters = "+remoteDtlsParameters);
    ...
    window.RTCPeerConnection.prototype._updateSignalingState =
        function(newState) {
		  ...
		  if (this.onsignalingstatechange !== null) {
			 //  alert("onsignalingstatechange !== null event = " +event);
  ...
  // Attach a media stream to an element.
  attachMediaStream: function(element, stream) {
	//  alert("attachMediaStream at line 1931 adapter.js");
    logging('DEPRECATED, attachMediaStream will soon be removed.');
    element.srcObject = stream;
  },
...
var firefoxShim = {
  ...
  // Attach a media stream to an element.
  attachMediaStream: function(element, stream) {
	 // alert("In attachMediaStream of adapter.js 2172");
    logging('DEPRECATED, attachMediaStream will soon be removed.');
    element.srcObject = stream;
  },
